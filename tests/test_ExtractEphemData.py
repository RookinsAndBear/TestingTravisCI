...
class Test_ExtractEphemData(unittest.TestCase):
    ...
    def test_dummy_ExtractPosVelCov(self):
        ...
        values_stk = ['29808000', 
                      '200705138.8', '-188817438.9', '-49873952.76',
                      '736.5850035', '-2', '370.4811842',
    ...
    def test_odtk_ExtractPosVelCov(self):
        ...
        values_stk = ['5.60600000000000e+03', 
                      ...
                      '1.05439097338782e+04', '-2.34492974147408e+03', '4.64345657396604e+03', '-3.14822202715566e+03', '6.06902201170811e+01', '4.29976728639937e+03', '-4.21413200898710e-02\n',
                      '3.35105510396153e-02', '2.13465219181365e-02', '3.95118694344618e-07', '-3.28871551875770e-02', '8.58497071571136e-04', '1.61123365254981e-02', '8.10171502110303e-08\n',
                      '1.77536195738882e-07', '4.21462146377177e-02', '1.97961560364326e-02', '-2.51847242620078e-02', '-2.47329891882243e-09', '-2.05478115461443e-07', '4.63398878632980e-07\n']
