...
from OrbitalElementsFromCartState import OrbitEnergyFromCartState
from OrbitalElementsFromCartState import SemimajorAxisFromCartState
...
def TransformCovarianceScalar(C1, M):
    ''' TransformCovarianceScalar: 
        ...
        OUTPUT: C2: scalar covariance in the second coord system
                     as C2 = M*C1*M'
    '''
